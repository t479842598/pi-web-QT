...
class AppLocalizations {
  ...
  static const _english = <String, String>{
    ...
    '取消置顶': 'Unpin',
    '选择项目': 'Select project',
    '选择其他目录…': 'Select another directory…',
    '今天': 'Today',
    '昨天': 'Yesterday',
    '更早': 'Earlier',
    '新建会话': 'New chat',
    ...
    '工作中': 'Working',
    '输入 {n} token': 'Input {n} tokens',
    '输出 {n} token': 'Output {n} tokens',
    '总计 {n} token': 'Total {n} tokens',
    '标题生成失败，请稍后重试': 'Title generation failed, try again later',
    '待办': 'Todo',
    '需关注': 'Needs attention',
    '已完成': 'Done',
    'AI 生成标题': 'AI title',
  ...
  static const _japanese = <String, String>{
    ...
    '标题已生成': 'タイトルを生成しました',
    '工作中': '作業中',
    '输入 {n} token': '入力 {n} token',
    '输出 {n} token': '出力 {n} token',
    '总计 {n} token': '合計 {n} token',
    '标题生成失败，请稍后重试': 'タイトル生成に失敗しました',
    '待办': '未着手',
    '需关注': '要対応',
    '已完成': '完了',
    'AI 生成标题': 'AIタイトル',
