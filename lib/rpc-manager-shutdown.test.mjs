...
test("a listener that unsubscribes while handling an event does not hide it from the next one", async () => {
  const inner = {
    isBashRunning: false,
    extensionRunner: {},
    dispose() {},
  ...
  wrapper.destroy();
  // Fork implementation defers the splice with queueMicrotask; flush it.
