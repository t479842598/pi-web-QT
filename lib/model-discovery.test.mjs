...
test("builds protocol-appropriate model list URLs", () => {
  ...
  assert.equal(buildModelsListUrl("https://api.mistral.ai", "mistral-conversations").toString(), "https://api.mistral.ai/v1/models");
  assert.equal(buildModelsListUrl("https://api.mistral.ai/v1", "mistral-conversations").toString(), "https://api.mistral.ai/v1/models");
