...
test("rejects malformed and unconfigured Host headers", () => {
  assert.equal(isApiRequestAllowed(makeRequest("GET", "localhost@attacker.example:30141")), false);
  assert.equal(isApiRequestAllowed(makeRequest("GET", "pi-web.internal:30141")), false);
});
