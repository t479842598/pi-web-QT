...
test("fork defaults: LAN binding, no auto browser open", () => {
...
test("PI_WEB_NO_OPEN cannot force auto-open in the fork (default stays off)", () => {
